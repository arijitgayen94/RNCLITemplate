...
const installDependencies = () => {
  ...
  console.log(
    "@arijitgayen94/RNCLITemplate initialized with success! 🚀\n"
  );
...
new Promise((resolve) => {
  ...
  .then(() => {
    console.log(
      "- 🎉  Congrats! Your project is ready with @arijitgayen94/RNCLITemplate! 🎉\n"
    );

    console.log(
      "- 📚 If you need to read more about this boilerplate : https://github.com/arijitgayen94/RNCLITemplate/blob/master/README.md\n"
    );
    console.log(
      "- 🤕 If you have some troubles : https://github.com/arijitgayen94/RNCLITemplate/issues\n"
    );
    console.log(
      "- ⭐ If you love this boilerplate, give us a star, you will be a ray of sunshine in our lives :) https://github.com/arijitgayen94/RNCLITemplate\n"
    );
  })
  .catch((error) => {
